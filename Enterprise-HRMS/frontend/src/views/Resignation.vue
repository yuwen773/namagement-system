      ...
      >
        <el-form-item label="员工信息">
          <div class="employee-info-display">
            ...
            <span class="employee-id">({{ selectedEmployee?.employee_id }})</span>
          </div>
        </el-form-item>
    ...
    >
      <div v-if="selectedEmployee" class="detail-content">
        ...
        <div class="detail-item">
          ...
          <span class="value">{{ formatDate(selectedEmployee.resigned_date) }}</span>
        </div>
        <div class="detail-item">
          <span class="label">离职原因：</span>
          <span class="value">{{ selectedEmployee.resigned_reason || '-' }}</span>
        </div>
      </div>
      <template #footer>
