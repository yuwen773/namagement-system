...
<template>
  <div class="dashboard-container">
    ...
    <!-- Quick actions -->
    <div class="actions-section animate-slide-up" style="animation-delay: 0.4s">
    ...
    <div class="charts-grid">
      ...
      <div class="chart-section animate-slide-up" style="animation-delay: 0.9s">
        <h2 class="section-title">
      ...
      <div class="chart-section animate-slide-up" style="animation-delay: 1s">
        <h2 class="section-title">
