...
| 2 | 数据库设计与模型创建 | 🔄 进行中 | 2026-01-29 | 用户表✅、菜谱表✅、食材表⏳ |
...
| 表名 | 优先级 | 预计阶段 | 备注 |
|:-----|:------:|:--------:|:-----|
| categories | 高 | 阶段二第6步 | 分类/标签表 |
| ingredients | 高 | 阶段二第3步 | 食材库 |
| recipe_ingredients | 高 | 阶段二第3步 | 菜谱-食材关联表 |
| user_favorites | 中 | 阶段二第4步 | 用户收藏表 |
| user_behavior_logs | 中 | 阶段二第5步 | 行为日志表 |
