...
from .serializers import InheritorReadSerializer, InheritorWriteSerializer


class InheritorViewSet(viewsets.ModelViewSet):
    queryset = Inheritor.objects.select_related("heritage_item", "region")
    ...
    def get_queryset(self):
        ...
        heritage_item = params.get("heritage_item")
        if heritage_item:
            queryset = queryset.filter(heritage_item_id=heritage_item)
    ...
    def get_serializer_class(self):
        if self.action in ("list", "retrieve"):
            return InheritorReadSerializer
        return InheritorWriteSerializer
    ...
    def create(self, request, *args, **kwargs):
        ...
        read_serializer = InheritorReadSerializer(
            serializer.instance,
