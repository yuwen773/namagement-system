...
const generateMockProduct = (id) => {
  const shops = ['泡泡玛特旗舰店', '万代官方旗舰店', '宝可梦官方', '原神旗舰店']
  const titles = [
    '泡泡玛特 SKULLPANDA 夜之城系列 潮玩手办',
    '万代 高达 MG RX-78-2 元祖高达模型',
    '宝可梦 皮卡丘 限量版毛绒玩具',
    '原神 钟离 限定版手办收藏'
  ]
  ...
  return {
    ...
    category: ['盲盒', '模型', '毛绒', '手办'][idx],
    brand: ['泡泡玛特', '万代', '宝可梦', '原神'][idx],
    description: '优质潮玩商品，正品保障，丰富收藏价值。',
    rating: 4.8,
    reviews: 1234
  }
}
      ...
      <div class="main-section">
        ...
        <div class="product-info">
          <div class="info-header">
            <div class="category-tag">{{ product.category || '潮玩' }}</div>
          ...
          <div class="stats-grid">
            ...
            <div class="stat-item">
              <span class="stat-value">{{ product.brand || '潮玩品牌' }}</span>
