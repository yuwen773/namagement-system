...
const generateMockTopSales = () => {
  return [
    { id: 1, title: '泡泡玛特 SKULLPANDA 夜之城系列 温蒂兔', sales: 50000, price: 99, shop: '泡泡玛特旗舰店', image: '' },
    { id: 2, title: 'Labubu 森林小屋系列 盲盒', sales: 42000, price: 129, shop: 'Labubu官方', image: '' },
    { id: 3, title: '高达 MG RX-78-2 Ver.3.0 拼装模型', sales: 38000, price: 280, shop: '万代官方旗舰店', image: '' },
    { id: 4, title: '龙珠Z 孙悟空超四 稀有手办', sales: 35000, price: 350, shop: '万代官方旗舰店', image: '' },
    { id: 5, title: '航海王 草帽团限定版手办套装', sales: 32000, price: 299, shop: '万代官方旗舰店', image: '' },
    { id: 6, title: '初音未来 Q版冰糖百合手办', sales: 28000, price: 89, shop: '萌趣旗舰店', image: '' },
    { id: 7, title: '蜡笔小新动感超人特别版', sales: 25000, price: 69, shop: '卡通王国', image: '' },
    { id: 8, title: '宝可梦 皮卡丘超大毛绒玩偶', sales: 22000, price: 159, shop: '宝可梦官方', image: '' },
    { id: 9, title: '原神 钟离岩王帝君手办', sales: 20000, price: 499, shop: '原神旗舰店', image: '' },
    { id: 10, title: '明日方舟 斯卡蒂浊心斯卡蒂', sales: 18000, price: 388, shop: '鹰角网络', image: '' }
  ]
}

const generateMockDrops = () => {
  return [
    { id: 11, title: '盲盒隐藏款限定', oldPrice: 79, currentPrice: 49, dropPercent: 38, sales: 5000, discount: 38 },
    { id: 12, title: '限量版钢铁侠MK50', oldPrice: 599, currentPrice: 459, dropPercent: 23, sales: 1200, discount: 23 },
    { id: 13, title: '盲盒圣诞特别款', oldPrice: 89, currentPrice: 69, dropPercent: 22, sales: 3200, discount: 22 }
  ]
}
  ...
  <div class="market-page">
    ...
    <header class="page-header stagger-children">
      <div class="header-content">
        ...
        <p class="page-subtitle">潮玩商品消费决策数据 · 实时监控 · 智能分析</p>
      </div>
    ...
    <section class="products-section stagger-children">
      <div class="section-header">
        <div class="section-title-group">
          ...
          <p class="section-subtitle">销量领先的潮玩商品</p>
        </div>
        <ActionButton
          variant="secondary"
          icon="ArrowRight"
