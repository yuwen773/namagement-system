...
const adminNavItems = [
  ...
  },
  {
    ...
    name: '录制管理',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="3" fill="currentColor"/></svg>',
    roles: ['admin']
  },
  {
    path: '/crawler/tasks',
  ...
  },
  {
    path: '/feedbacks',
    name: '反馈管理',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/><path d="M8 10h.01M12 10h.01M16 10h.01"/></svg>',
    roles: ['admin']
  },
  {
    path: '/profile',
